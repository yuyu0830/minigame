...
class gun_n_bullet:
    def __init__(self, screen, mousepoint, gun, character, character_pos):
        print(mousepoint)
    ...
    def gun_draw(self, screen, gun):
        ...
        self.mouse_point_blit = (self.blit_x - self.gun_width / 2), (self.blit_y - self.gun_height / 2)
    ...
    def gun_shoot(self):
        ...
        self.m_x = (self.screen_center[0] - self.mouse_point[0])
        self.m_y = (self.screen_center[1] - self.mouse_point[1])
        ...
        if self.circle_to_center > self.circle_radius**2:
            if self.m_x > 0:
                ...
                self.blit_y = self.screen_center[1] - (self.circle_radius * y) 
            elif self.m_x < 0:
                self.blit_x = self.screen_center[0] + (self.circle_radius * self.x) 
                self.blit_y = self.screen_center[1] + (self.circle_radius * y) 
        else:
            self.blit_x = self.mouse_point[0] 
            self.blit_y = self.mouse_point[1]  

        self.mouse_point_blit = (self.blit_x - self.gun_width / 2), (self.blit_y - self.gun_height / 2)

        self.screen.blit(self.gun, self.mouse_point_blit)
...
class character:
    ...
    def center_pos(self, screen_width, screen_height, to_x, to_y):
        ...
        self.character_x = self.character_width / 2 + to_x
        self.character_y = self.character_height / 2 + to_y
